...
#define MAX_PER_STAT_EVS (P_FIXED_EVS ? 0 : ((P_EV_CAP >= GEN_6) ? 252 : 255))
#define MAX_TOTAL_EVS (P_FIXED_EVS ? 0 : 510)
#define EV_ITEM_RAISE_LIMIT (P_FIXED_EVS ? 0 : ((I_VITAMIN_EV_CAP >= GEN_8) ? MAX_PER_STAT_EVS : 100))
