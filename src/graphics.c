...
const u16 gBattleInterface_TypeIconsPal[] = INCBIN_U16("graphics/battle_interface/type_icons.gbapal");
const u32 gBattleInterface_TypeIconsGfx[] = INCBIN_U32("graphics/battle_interface/type_icons.4bpp.lz");
