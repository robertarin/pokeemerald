...
static const u8 sMapHealLocations[][3] =
{
    ...
    // ra-master map heal locations
    [MAPSEC_SUNCLOAK_TOWN] = {MAP_GROUP(MAP_SUNCLOAK_TOWN), MAP_NUM(MAP_SUNCLOAK_TOWN), HEAL_LOCATION_SUNCLOAK_TOWN},
    [MAPSEC_ROUTE_201] = {MAP_GROUP(MAP_ROUTE201), MAP_NUM(MAP_ROUTE201), HEAL_LOCATION_NONE},
};
