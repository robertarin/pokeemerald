...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    // New maps
    [MAPSEC_ROUTE_201 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SUNCLOAK_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    // New maps
    [MAPSEC_ROUTE_201 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SUNCLOAK_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
